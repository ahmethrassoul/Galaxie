 ...
 *
 */
#include "BackEndColoredSprite.hpp"
#include "../others/text.h"
#include "../BackEndSprite/tools.hpp"
#include <chrono>
#include <iostream>
...
extern float evalHermite(float pA, float pB, float vA, float vB, float u);
extern unsigned char* createGaussianMap(int N);
//
//
////////////////////////////////////////////////////////////////////////////////////////////////
//
//
BackEndColoredSprite::BackEndColoredSprite(const int _width, const int _height, const std::string colorfile) : OpenGLRender(_width, _height, colorfile)
{
    //
    // On cree les textures utilisées par la suite
    //
...
//
//
BackEndColoredSprite::~BackEndColoredSprite()
{
...
//
//
void BackEndColoredSprite::render(Galaxy* galaxie)
{
