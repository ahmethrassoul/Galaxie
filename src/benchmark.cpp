...
//    std::cout << "(II) + " << std::put_time(std::localtime(&t), "%c %Z") << '\n';
    ...
    std::cout << "(II) Loaded particules =  [" << galaxie.size  << "]" << std::endl;
    printf("(II)\n");
    ...
    {
        printf("(II) Launching RenderOpenMP measure\r");
        ...
        printf("[openmp   ]  | EXEC %4d | TIME %3ds | FPS %7.3f | Speed-up %7.3f |\n", n_mod, (int)(execTime_mod/1000), fps_mod, speedup);
    }

    {
        printf("(II) Launching RenderOptimOpenMP measure\r");
        fflush(stdout);
